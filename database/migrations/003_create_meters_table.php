...
return new class extends Migration
{
    ...
    {
        Schema::connection(config('fastchart.database.n.connection', 'sqlite'))->create('meters', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::connection(config('fastchart.database.n.connection', 'sqlite'))->dropIfExists('meters');
    }
};
